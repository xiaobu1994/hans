...
import com.xiaobu.mapper.DictMapper;
import com.xiaobu.service.IDictService;
import com.xiaobu.warpper.DictWarpper;
...
public class DictController extends BaseController {
     ...
     */
    @BussinessLog(value = "添加字典记录", key = "dictName,dictValues", dict = com.xiaobu.common.constant.Dict.DictMap)
     ...
     * 修改字典
     */
    @BussinessLog(value = "修改字典", key = "dictName,dictValues", dict = com.xiaobu.common.constant.Dict.DictMap)
     ...
     * 删除字典记录
     */
    @BussinessLog(value = "删除字典记录", key = "dictId", dict = com.xiaobu.common.constant.Dict.DeleteDict)
